...
class Person:
    ...
    def simulate(self, salary):
        ...
        print(f"所得税: ¥{country_tax}")
        #print(f"控除後住民税課税所得: ¥{country.deducted_income}")
        print(f"住民税: ¥{resident_tax}")
...
if __name__ == "__main__":
    ...
    while True:
        print("=" * 25)
        salary = int(input("所得: "))
        res = person.simulate(salary=salary)
        print(f"手取り: ¥{res}")
